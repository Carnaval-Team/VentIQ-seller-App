-- ✅ FUNCIÓN insert_producto_completo COMPLETAMENTE CORREGIDA
-- Reemplaza toda la función con esta versión corregida

CREATE OR REPLACE FUNCTION insert_producto_completo_V2(
    producto_data JSONB,
