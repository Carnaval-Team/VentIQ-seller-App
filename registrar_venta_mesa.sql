-- FUNCTION: public.fn_registrar_venta_mesa
-- Versión "mesa" del registro de venta, con soporte para id_mesa (modo restaurante).
--
-- DROP FUNCTION IF EXISTS public.fn_registrar_venta_mesa(bigint, uuid, jsonb, text, text, text, smallint, bigint, bigint);
      ...
      IF v_es_elaborado = true THEN
        ...
        LOOP
          ...
          INSERT INTO app_dat_inventario_productos (
            ...
            v_inventario_ingrediente.cantidad_final,
            v_inventario_ingrediente.cantidad_final - v_ingrediente.cantidad_total_necesaria,
...
ALTER FUNCTION public.fn_registrar_venta_mesa(bigint, uuid, jsonb, text, text, text, smallint, bigint, bigint)
    OWNER TO postgres;
...
GRANT EXECUTE ON FUNCTION public.fn_registrar_venta_mesa(bigint, uuid, jsonb, text, text, text, smallint, bigint, bigint) TO postgres;
