...
class FluidPaymentMethodsWidget extends StatefulWidget {
  ...
  @override
  State<FluidPaymentMethodsWidget> createState() =>
      _FluidPaymentMethodsWidgetState();
}
...
class _FluidPaymentMethodsWidgetState extends State<FluidPaymentMethodsWidget> {
  ...
  void _calculateTotalAmount() {
    _totalAmount = widget.orderItems.fold(
      0.0,
  ...
  void _updateRemainingAmount() {
    final totalPaid = _selectedPaymentMethods.fold(
      0.0,
        ...
        child: Column(
          ...
          children: [
            ...
            if (_availablePaymentMethods.isEmpty)
              Text(
                'No hay métodos de pago disponibles. Sincroniza con conexión para habilitarlos.',
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              onChanged:
                                  (value) => _updatePaymentAmount(index, value),
                            ),
                          ),
                        ],
                      ),
            ...
            Wrap(
              ...
              children: [
                ...
                if (_remainingAmount > 0)
                  ActionChip(
                    label: Text(
                      'Pagar resto en efectivo (\$${_remainingAmount.toStringAsFixed(2)})',
                    ),
  ...
  Widget _buildContinueButton() {
    final canContinue =
        _remainingAmount <= 0.01 && _selectedPaymentMethods.isNotEmpty;
