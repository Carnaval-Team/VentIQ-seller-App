                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    ...
                    BoxShadow(
                      ...
                      blurRadius: _elevationAnimation.value + 16,
                      offset: Offset(0, _elevationAnimation.value / 2.4),
                    ),
                  ],
                ),
                child: ClipRRect(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      double imageSize = constraints.maxWidth * 0.52;
                      final maxFromHeight = constraints.maxHeight * 0.56;
                      if (imageSize > maxFromHeight) {
                        imageSize = maxFromHeight;
                      }
                      imageSize =
                          imageSize.clamp(96.0, 162.0).toDouble();
                      final textRightPadding = imageSize * 0.42;
                      return Stack(
                        children: [
                          // Background gradient
                          Positioned.fill(
