-- ============================================================
-- fn_listar_ordenes_v2
-- Versión actualizada que incluye sku_producto, descripcion
-- y sku_ubicacion en los items de cada orden.
-- ============================================================
...
CREATE OR REPLACE FUNCTION public.fn_listar_ordenes(
    ...
    id_estado_param        SMALLINT  DEFAULT NULL,
    fecha_desde_param      DATE      DEFAULT NULL,
    fecha_hasta_param      DATE      DEFAULT NULL,
...
-- Permisos
GRANT EXECUTE ON FUNCTION public.fn_listar_ordenes(
    BIGINT, BIGINT, UUID, SMALLINT, DATE, DATE, BIGINT, BOOLEAN, BOOLEAN, INTEGER, INTEGER
) TO authenticated;
