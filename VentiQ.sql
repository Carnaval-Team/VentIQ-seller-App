...
CREATE TABLE public.app_dat_trabajadores (
  ...
  user_mail text,
  tipo_salario text NOT NULL DEFAULT 'hora'::text CHECK (tipo_salario = ANY (ARRAY['hora'::text, 'dia'::text])),
  salario_dia numeric NOT NULL DEFAULT 0,
...
CREATE TABLE public.app_dat_configuracion_tienda (
  ...
  modo_restaurante boolean NOT NULL DEFAULT false,
  cambiar_fecha_creacion_operacion_al_cierre boolean NOT NULL DEFAULT false,
  permitir_modo_offline_completo boolean NOT NULL DEFAULT false,
  dias_max_sin_validar_licencia integer NOT NULL DEFAULT 7,
  mostrar_debe_haber_en_conteo_inventario boolean NOT NULL DEFAULT false,
  guardar_impresora_por_defecto boolean NOT NULL DEFAULT false,
