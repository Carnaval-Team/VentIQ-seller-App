        ...
        SELECT
            ...
            CASE
                WHEN o.id_tipo_operacion = (SELECT top_sub.id FROM app_nom_tipo_operacion top_sub WHERE top_sub.denominacion = 'Venta') THEN
                    ...
                    GROUP BY tpv.id, tpv.denominacion, ov_inner.monto_total)
        ...
        jsonb_build_object(
            ...
            'items', (
                ...
                FROM (
                    ...
                    UNION ALL
                    SELECT rep.id_producto, rep.id_variante, rep.id_opcion_variante, rep.id_presentacion, rep.cantidad, rep.precio_unitario, rep.importe 
