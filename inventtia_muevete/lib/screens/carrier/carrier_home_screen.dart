...
class CarrierHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final name = (auth.driverProfile?['name'] as String?) ?? 'Transportista';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Panel de Transportista de Carga — Próximamente',
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 15,
                  color: textSecondary,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Aquí podrás ver cargas disponibles, enviar ofertas y gestionar tus envíos activos.',
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 13,
                  color: textSecondary,
                ),
