...
class DispatcherHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final name = (auth.driverProfile?['name'] as String?) ?? 'Dispatcher';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Panel de Dispatcher — Próximamente',
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 15,
                  color: textSecondary,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Aquí podrás gestionar tu flota de transportistas, asignar cargas y monitorear todas las operaciones.',
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 13,
                  color: textSecondary,
                ),
