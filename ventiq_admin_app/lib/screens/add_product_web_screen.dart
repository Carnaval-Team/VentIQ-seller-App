...
class AddProductWebScreen extends StatefulWidget {
  ...
  const AddProductWebScreen({Key? key, this.product, this.onProductSaved})
    : super(key: key);
...
class _AddProductWebScreenState extends State<AddProductWebScreen> {
          ...
          Padding(
            ...
            child: ElevatedButton.icon(
              ...
              icon: _isLoading
                  ...
                  : Icon(
                      isEditing ? Icons.save_outlined : Icons.check_rounded,
                      size: 18,
                    ),
              label: Text(
                _isLoading
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildWebCard(
                          ...
                          subtitle: 'Precio base para cálculos',
                          icon: Icons.sell_outlined,
                          iconColor: AppColors.success,
                          child: _buildPriceWebContent(),
                        ),
                        const SizedBox(height: 20),

                        // Card: Presentación base
                        _buildWebCard(
                          title: 'Presentación Base',
                          subtitle: 'Unidad mínima de venta',
                          icon: Icons.inventory_2_outlined,
                          child: _buildBasePresentationWebContent(),
                        ),
                        const SizedBox(height: 20),
                        ...
                        _buildWebCard(
                          ...
                          subtitle: 'Datos comerciales y código de barras',
                          icon: Icons.description_outlined,
                          child: _buildAdditionalInfoWebContent(),
                        ),
                        const SizedBox(height: 20),
                        ...
                        _buildWebCard(
                          ...
                          child: _buildPropertiesWebContent(),
                        ),
                        const SizedBox(height: 20),
                        ...
                        _buildWebCard(
                          title: 'Etiquetas',
                          subtitle: 'Palabras clave para búsqueda',
  ...
  /// InputDecoration estandar para todos los campos del formulario.
  /// Estilo filled con fondo #F9FAFB, radius 10, focus azul primario.
  ...
  /// Mensaje informativo estilizado y consistente.
  /// tipo: 'info' (azul), 'warning' (naranja), 'primary' (azul primary suave)
  ...
  /// Botón de acción secundario compacto, estilo consistente.
  ...
  Widget _buildPriceWebContent() {
    return Column(
      ...
      children: [
        ...
        _buildInfoMessage(
          message: 'Este precio se usa como base para calcular los precios de las presentaciones adicionales.',
          type: 'info',
        ),
      ],
    );
  ...
  Widget _buildBasePresentationWebContent() {
    if (_presentaciones.isEmpty) {
      return _buildLoadingPlaceholder('Cargando presentaciones...');
    }
    return _buildBasePresentationSubsection();
  }

  /// Placeholder de carga reutilizable.
  ...
  /// Estado vacío reutilizable: icono grande + título + descripción + CTA opcional.
  ...
  Widget _buildPresentacionesAdicionalesWebContent() {
    if (_presentacionesAdicionales.isEmpty) {
      return _buildEmptyState(
        icon: Icons.inventory_outlined,
        title: 'Sin presentaciones adicionales',
        description:
            'Agrega presentaciones alternativas como Blister 6 uds, Caja 24 uds, Pallet 100 uds.',
      );
    }
                  ...
                  children: [
                    ...
                    if (presentacion['precio'] != null) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          '\$${presentacion['precio'].toStringAsFixed(2)}',
                          style: const TextStyle(
  ...
  /// Botón de icono pequeño con fondo sutil consistente.
  ...
  /// Chip-toggle ultra compacto: icono + texto + fondo según estado.
  /// Reemplaza a los switches para ahorrar espacio vertical.
    ...
    final Widget chip = Material(
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
          decoration: BoxDecoration(
            color: value ? AppColors.primary : Colors.grey.shade100,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
  ...
  Widget _buildPropertiesWebContent() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Wrap(
          ...
          children: [
            _buildPropertyChip(
              ...
              onChanged: (v) => setState(() => _esRefrigerado = v),
            ),
            _buildPropertyChip(
              label: 'Frágil',
              ...
              tooltip: '',
              value: _esFragil,
              onChanged: (v) => setState(() => _esFragil = v),
            ),
            _buildPropertyChip(
              label: 'Peligroso',
            ...
            _buildPropertyChip(
              ...
              tooltip: '',
              value: _esPorLotes,
              onChanged: (v) => setState(() => _esPorLotes = v),
            ),
            _buildPropertyChip(
              label: 'Vendible',
              ...
              tooltip: '',
              value: _esVendible,
              onChanged: (v) => setState(() => _esVendible = v),
            ),
            _buildPropertyChip(
              label: 'Comprable',
              ...
              tooltip: '',
              value: _esComprable,
              onChanged: (v) => setState(() => _esComprable = v),
            ),
            _buildPropertyChip(
              label: 'Inventariable',
              icon: Icons.inventory_2_outlined,
              ...
              onChanged: (v) => setState(() => _esInventariable = v),
            ),
            _buildPropertyChip(
              label: 'Elaborado',
              ...
              onChanged: (v) => setState(() {
                _esElaborado = v;
                if (!_esElaborado) { _ingredientes.clear(); _costoProduccionCalculado = 0.0; }
              }),
            ),
            _buildPropertyChip(
              label: 'Servicio',
              ...
              onChanged: (v) => setState(() {
                _esServicio = v;
                if (!_esServicio) { _ingredientes.clear(); _costoProduccionCalculado = 0.0; }
              }),
            ),
          ],
        ),
        ...
        if (_esElaborado || _esServicio) ...[
          ...
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(
                    _esServicio ? Icons.inventory_2_outlined : Icons.restaurant_menu_outlined,
                    size: 18,
                    color: AppColors.primary,
                  ),
                  const SizedBox(width: 8),
                  Text(
                    _esServicio ? 'Productos necesarios' : 'Ingredientes',
                    style: const TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
                      color: AppColors.textPrimary,
          ...
          if (_ingredientes.isEmpty)
            _buildEmptyState(
              icon: _esServicio ? Icons.inventory_2_outlined : Icons.restaurant_menu_outlined,
              title: _esServicio ? 'Sin productos agregados' : 'Sin ingredientes agregados',
              description: _esServicio
                  ? 'Agrega los productos que conforman este servicio.'
                  : 'Agrega los ingredientes para calcular el costo de producción.',
            )
          else
            ...List.generate(_ingredientes.length, (index) {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            '${ingrediente['cantidad']} ${ingrediente['unidad'] ?? 'und'}',
                            style: const TextStyle(
                              fontSize: 12,
                              color: AppColors.textSecondary,
                            ),
  ...
  Widget _buildPropertyGroupLabel(String label) {
    return Text(
      label.toUpperCase(),
      style: TextStyle(
        fontSize: 11,
  ...
  /// Compat: método _buildCompactToggle mantenido por si se referencia en otro lado.
  Widget _buildCompactToggle(String label, String tooltip, bool value, ValueChanged<bool> onChanged) {
    return _buildPropertyChip(
      label: label,
  ...
  Widget _buildAdditionalInfoWebContent() {
    return Column(
      children: [
        Row(
          children: [
            Expanded(
              child: TextFormField(
                ...
                decoration: _inputDecoration(label: 'Nombre Comercial', hint: 'Marca'),
              ),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: TextFormField(
                ...
                decoration: _inputDecoration(label: 'Denominación Corta'),
              ),
            ),
          ],
        ),
        ...
        TextFormField(
          ...
          decoration: _inputDecoration(label: 'Descripción Corta', hint: 'Descripción breve'),
          maxLines: 2,
        ),
        const SizedBox(height: 14),
        Row(
          ...
          children: [
            Expanded(
              child: TextFormField(
                ...
                decoration: _inputDecoration(
                  ...
                  prefixIcon: Icon(Icons.qr_code_rounded, size: 20, color: Colors.grey.shade500),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed:
                    _isLoadingOpenFoodFacts ? null : _openBarcodeScanner,
  ...
  Widget _buildVariantesWebContent() {
    InputDecoration baseDecoration(String label, {String? hint, String? prefix}) {
      return InputDecoration(
        labelText: label,
        hintText: hint,
        prefixText: prefix,
    ...
    return Column(
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                decoration: baseDecoration('Atributo', hint: 'Selecciona un atributo'),
                items: _atributos.map((atributo) {
                  return DropdownMenuItem<int>(
                    value: atributo['id'],
                    child:
                        Text(atributo['denominacion'] ?? 'Sin nombre'),
                  );
                }).toList(),
                onChanged: (value) {
              ...
              TextFormField(
                ...
                decoration: baseDecoration('Precio', hint: '0.00', prefix: '\$ '),
                keyboardType:
        ...
        if (_selectedVariantes.isNotEmpty) ...[
          Text(
            'VARIANTES AGREGADAS (${_selectedVariantes.length})',
            style: TextStyle(
              fontSize: 11,
              fontWeight: FontWeight.w700,
              color: Colors.grey.shade600,
          ...
          _buildEmptyState(
            ...
            title: 'Sin variantes',
            description: 'Las variantes permiten diferenciar el mismo producto por color, talla, etc.',
          ),
      ],
    );
  }

  Widget _buildTagsWebContent() {
    if (_etiquetas.isEmpty) {
      return _buildEmptyState(
        icon: Icons.local_offer_outlined,
        title: 'Sin etiquetas',
        description: 'Agrega palabras clave para facilitar búsquedas.',
      );
    }
    return Wrap(
      spacing: 8,
      ...
      children: _etiquetas.map((etiqueta) {
        return Chip(
          ...
          deleteIcon: Icon(Icons.close_rounded, size: 16, color: AppColors.primary),
          onDeleted: () {
  ...
  Widget _buildMultimediaWebContent() {
    if (_multimedias.isEmpty) {
      return _buildEmptyState(
        icon: Icons.image_outlined,
        title: 'Sin multimedia',
        description: 'Agrega imágenes o recursos multimedia del producto.',
      );
    }
    return Column(
  ...
  Widget _buildBasicInfoSubsection() {
    final bool isEditing = widget.product != null;
    final bool skuReadOnly = !_skuManual;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // SKU + Nombre (fila: SKU compacto, Nombre ocupa más espacio)
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(
              ...
              child: TextFormField(
                ...
                decoration: _inputDecoration(
                  label: 'SKU *',
                  hint: _skuManual || isEditing
                      ? 'Ingrese el SKU'
                      : 'Se genera automáticamente',
                  prefixIcon: Icon(
                    _skuManual || isEditing ? Icons.edit_outlined : Icons.auto_awesome_outlined,
                    size: 18,
                    color: AppColors.primary,
                  ),
                ),
        ...
        const SizedBox(height: 10),
        // Toggle SKU manual - chip compacto (sin tooltip)
        Row(
          children: [
            _buildPropertyChip(
              label: isEditing ? 'Editar SKU' : 'SKU Manual',
              icon: Icons.edit_outlined,
              tooltip: '',
              value: _skuManual,
              onChanged: (value) {
            ...
            if (_skuManual)
              Expanded(
                child: Text(
                  'Ingresa un SKU único para el producto',
                  style: TextStyle(
                    fontSize: 12,
                    color: Colors.grey.shade600,
        ...
        if (_categorias.isEmpty) ...[
          _buildInfoMessage(
            type: 'warning',
            icon: Icons.warning_amber_rounded,
            message: 'No hay categorías disponibles. Para crear un producto necesitas al menos una categoría con una subcategoría.',
          ),
          const SizedBox(height: 12),
          SizedBox(
            width: double.infinity,
    ...
    return Column(
      ...
      children: [
        ...
        if (_selectedCategoryId == null) ...[
          _buildInfoMessage(
            type: 'info',
            message: 'Selecciona una categoría para ver las subcategorías disponibles.',
          ),
        ]
        // Estado: Categoría seleccionada pero sin subcategorías
          ...
          _buildInfoMessage(
            type: 'warning',
            message: 'No hay subcategorías disponibles para esta categoría.',
          ),
          const SizedBox(height: 12),
          SizedBox(
            width: double.infinity,
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<int?>(
          ...
          decoration: _inputDecoration(
            label: 'Proveedor',
            hint: 'Selecciona un proveedor (opcional)',
            prefixIcon: Icon(
  ...
  Widget _buildBasePresentationSubsection() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Primera fila: Tipo de Presentación (dropdown grande) + Cantidad
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(
              ...
              child: DropdownButtonFormField<int>(
                ...
                decoration: _inputDecoration(
                  ...
                  hint: 'Selecciona una presentación',
                ),
            ...
            Expanded(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  ...
                  if (cantidad == null || cantidad <= 0) return 'Inválida';
                  return null;
                },
              ),
            ),
        ...
        const SizedBox(height: 14),
        // Segunda fila: Unidad de Medida + Cantidad UM
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(
              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return _buildLoadingPlaceholder('Cargando unidades...');
                  }
                  ...
                  String? currentValue = _unidadMedidaController.text.isNotEmpty
                      ? _unidadMedidaController.text
                      : null;

                  if (currentValue != null &&
                      !unidadesLimpias.any((u) => u['abreviatura'] == currentValue)) {
                    currentValue = null;
                    _unidadMedidaController.text = '';
                  }
                  ...
                  return DropdownButtonFormField<String>(
                    ...
                    items: unidadesLimpias.map((unidad) {
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        final unidadSeleccionada = unidadesLimpias.firstWhere(
                    ...
                    validator: (value) =>
                        value == null || value.isEmpty ? 'Selecciona una unidad' : null,
                  );
                },
              ),
            ),
            ...
            Expanded(
              ...
              child: TextFormField(
                ...
                decoration: _inputDecoration(
                  label: 'Cantidad UM *',
                  hint: '1',
                  helperText: 'UM por presentación',
                ),
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                validator: (value) {
                  if (value == null || value.isEmpty) return 'Requerido';
        ...
        _buildInfoMessage(
          type: 'primary',
          message: 'La presentación base define la unidad mínima de venta. Ejemplo: 1 Unidad = 1 und, 1 Caja = 24 und.',
        ),
      ],
    );
  }
