...
class MonedasDepositosScreen extends StatefulWidget {
  const MonedasDepositosScreen({super.key});

  @override
  State<MonedasDepositosScreen> createState() =>
      _MonedasDepositosScreenState();
}

class _MonedasDepositosScreenState extends State<MonedasDepositosScreen> {
  ...
  void _showMonedaDialog({MonedaDeposito? moneda}) {
  ...
  Future<void> _toggleActivo(MonedaDeposito moneda) async {
    try {
