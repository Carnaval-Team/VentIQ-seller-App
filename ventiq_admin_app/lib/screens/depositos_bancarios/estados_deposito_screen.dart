...
class EstadosDepositoScreen extends StatefulWidget {
  const EstadosDepositoScreen({super.key});

  @override
  State<EstadosDepositoScreen> createState() => _EstadosDepositoScreenState();
}

class _EstadosDepositoScreenState extends State<EstadosDepositoScreen> {
  ...
  void _showEstadoDialog({EstadoDeposito? estado}) {
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final nuevoEstado = EstadoDeposito(
                          id: estado?.id ?? 0,
  ...
  Future<void> _deleteEstado(EstadoDeposito estado) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Estados de Depósito'),
