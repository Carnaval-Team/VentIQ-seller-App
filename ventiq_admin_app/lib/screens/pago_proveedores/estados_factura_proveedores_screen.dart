...
class EstadosFacturaProveedoresScreen extends StatefulWidget {
  const EstadosFacturaProveedoresScreen({super.key});

  @override
  State<EstadosFacturaProveedoresScreen> createState() => _EstadosFacturaProveedoresScreenState();
}

class _EstadosFacturaProveedoresScreenState extends State<EstadosFacturaProveedoresScreen> {
  ...
  void _showEstadoDialog({EstadoFacturaProveedor? estado}) {
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final nuevoEstado = EstadoFacturaProveedor(
                          id: estado?.id ?? 0,
  ...
  Future<void> _deleteEstado(EstadoFacturaProveedor estado) async {
