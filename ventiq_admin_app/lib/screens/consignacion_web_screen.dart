...
class ConsignacionWebScreen extends StatefulWidget {
  const ConsignacionWebScreen({Key? key}) : super(key: key);

  @override
  State<ConsignacionWebScreen> createState() => _ConsignacionWebScreenState();
}

class _ConsignacionWebScreenState extends State<ConsignacionWebScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: !_canCreateConsignacion
          ? null
              ...
              children: [
                ...
                if (_contratos.isEmpty)
                  _buildEmptyState(
                    ...
                    description:
                        'Cuando existan contratos activos aparecerán aquí.',
                  )
                else
                  ..._contratos
                      .take(5)
                ...
                child: _isSearching
                    ...
                    : _contratos.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemCount:
                                _contratos.length + (_hasMore ? 1 : 0),
  ...
  Widget _buildContratoAcciones(
    Map<String, dynamic> contrato,
    bool esConsignadora,
    int estadoConfirmacion,
  ) {
    return Column(
                  ...
                  child: FutureBuilder<bool>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ElevatedButton.icon(
                        onPressed: puedeRescindirse
                            ? () => _mostrarDialogoRescision(contrato)
                            : null,
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: puedeRescindirse
                              ? Colors.red
                              : Colors.grey[300],
                          foregroundColor:
                              puedeRescindirse ? Colors.white : Colors.grey,
                          padding: const EdgeInsets.symmetric(vertical: 10),
                        ),
                      );
                    },
          ...
          if (estadoConfirmacion == 0) ...[
            Row(
              children: [
                ...
                if (_canConfirmConsignacion && _canDeleteConsignacion)
                  const SizedBox(width: 8),
                if (_canDeleteConsignacion)
                  Expanded(
                    child: ElevatedButton.icon(
        ...
        builder: (context, setState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: idAlmacenSeleccionado == null
                    ? Colors.grey[300]
                    : Colors.green,
                foregroundColor: idAlmacenSeleccionado == null
                    ? Colors.grey
                    : Colors.white,
              ),
            ),
