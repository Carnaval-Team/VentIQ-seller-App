  ...
  Widget _buildStatsCard() {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildStatItem('Total TPVs', totalTpvs.toString(), Icons.point_of_sale),
          _buildStatItem('Con Vendedor', tpvsConVendedor.toString(), Icons.person),
          _buildStatItem(
            'Disponibles',
    ...
    switch (action) {
      ...
      case 'prices':
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TpvPricesScreen(
              tpvId: tpv['id'] is int ? tpv['id'] : int.parse(tpv['id'].toString()),
            ),
          ),
        );
        break;
      case 'stats':
        TpvDetailsDialog.showStatsDialog(
          context: context,
          tpv: tpv,
        );
        break;
