-- ============================================================================
-- FUNCIÓN: rechazar_producto_envio_consignacion
-- DESCRIPCIÓN: Rechaza un producto individual dentro de un envío de consignación.
--              Si el envío está EN TRÁNSITO, devuelve el stock de ese producto.
-- ============================================================================
...
BEGIN
  ...
  -- 5. Registrar movimiento del producto
  ...
  -- 6. Verificar si todos los productos del envío están ahora procesados (ya no hay ninguno en estado 1 = PROPUESTO)
  IF NOT EXISTS (
    SELECT 1 FROM app_dat_consignacion_envio_producto
  ...
  RETURN QUERY SELECT TRUE, 'Producto rechazado exitosamente.'::TEXT;
