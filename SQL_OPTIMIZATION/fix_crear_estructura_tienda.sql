-- ============================================================================
-- FIX: Actualizar RPC crear_estructura_tienda con campos de ubicación
-- Agregar: pais, estado, nombre_pais, nombre_estado, latitude, longitude
-- ============================================================================

DROP FUNCTION IF EXISTS public.crear_estructura_tienda(
  usuario_creador UUID,
  denominacion_tienda VARCHAR,
  direccion_tienda VARCHAR,
  ubicacion_tienda VARCHAR,
  almacenes_data JSONB,
  tpv_data JSONB,
  personal_data JSONB,
  layouts_data JSONB
) CASCADE;

CREATE OR REPLACE FUNCTION public.crear_estructura_tienda(
    usuario_creador UUID,
    denominacion_tienda VARCHAR,
    direccion_tienda VARCHAR,
    ubicacion_tienda VARCHAR,
    ...
    nombre_pais VARCHAR DEFAULT NULL,
    nombre_estado VARCHAR DEFAULT NULL,
...
BEGIN
    -- Crear la tienda principal CON CAMPOS DE UBICACIÓN
