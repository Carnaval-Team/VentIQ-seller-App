-- ============================================================================
-- FUNCIÓN: crear_envio_consignacion
-- DESCRIPCIÓN: Crea un envío de consignación con duplicación de productos
-- ESTRUCTURA CORRECTA (basada en debug que funciona)
-- ============================================================================
