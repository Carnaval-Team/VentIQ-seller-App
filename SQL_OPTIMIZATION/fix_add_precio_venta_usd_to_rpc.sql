-- ============================================================
-- FIX: Agregar precio_venta_usd al RPC get_productos_completos_by_tienda_optimized
    ...
    SELECT jsonb_build_object(
        ...
        'productos', jsonb_agg(
            jsonb_build_object(
                ...
                'es_elaborado', pc.es_elaborado,
                'es_servicio', pc.es_servicio,
