-- Fix: varios turnos abiertos del mismo TPV/usuario (apertura offline
-- duplicada al sincronizar) hacían fallar fn_cerrar_turno_tpv con
-- "query returned more than one row" y el turno quedaba abierto online.
-- Cierra el más reciente (ORDER BY + LIMIT 1).
