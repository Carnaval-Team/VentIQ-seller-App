...
-- Incluye cálculo correcto de stock disponible (descontando stock reservado)
...
-- 1. Agregados parámetros p_id_tienda y p_id_almacen para filtrado
-- 2. Agregados parámetros p_busqueda, p_mostrar_sin_stock, p_limite, p_pagina para funcionalidad completa
-- 3. Agregada validación de acceso a tienda usando check_user_has_access_to_tienda
-- 4. Agregada validación de que el almacén pertenezca a la tienda
-- 5. Modificado inventario_con_acceso para incluir filtro por almacén
-- 6. Agregado cálculo de stock_reservado usando la misma lógica que la función de referencia
-- 7. Agregado stock_disponible que descuenta el stock reservado del stock total
-- 8. Agregada paginación con conteo total
-- 9. Agregada búsqueda por texto en denominación, SKU, código de barras y valores de variantes
-- 10. Retorna total_count para implementar paginación en el frontend

-- Para usar la función:
-- SELECT * FROM fn_inventario_resumen_por_usuario(); -- Todos los productos de todas las tiendas accesibles
...
-- SELECT * FROM fn_inventario_resumen_por_usuario(p_busqueda := 'aceite'); -- Buscar productos que contengan 'aceite'
